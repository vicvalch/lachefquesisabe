      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 md:grid-cols-2 md:items-center">
        <div>
          ...
          <p className="mt-4 text-ink-soft">
            Soy María Checa Arias-Schreiber, la chef que sí sabe. Llevo años
            enseñando a cocinar con Thermomix de forma simple y cercana, sin
            tecnicismos ni presión. Conocé cómo Thermomix puede simplificar
            tu cocina con un acompañamiento pensado para tu día a día.
          </p>
        </div>
